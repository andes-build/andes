...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Andes 모바일 버튼 표시',
    zh: '显示 Andes Mobile 按钮',
    ja: 'Andes Mobile ボタンを表示'
  },
  ...
  'menu.exploreOrca': { ko: 'Andes 둘러보기', zh: '探索 Andes', ja: 'Andes を探索' },
  ...
  // Onboarding pill beside Andes Mobile: "New" marks a new feature, not a create action.
