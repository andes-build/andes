...
export const ZH_PHRASE_FIXES_ROUND5 = [
  { pattern: /Andes集成开发环境/g, replacement: 'Andes IDE', whenEnIncludes: 'Andes IDE' },
  { pattern: /Andes第一/g, replacement: 'Andes 优先', whenEnIncludes: 'Andes first' },
  { pattern: /Andes移动/g, replacement: 'Andes Mobile', whenEnIncludes: 'Andes Mobile' },
  { pattern: /Andes标志/g, replacement: 'Andes 标志', whenEnIncludes: 'Andes logo' },
  { pattern: /喜欢Andes/g, replacement: '喜欢 Andes', whenEnIncludes: 'Enjoying Andes' },
  { pattern: /认识Andes/g, replacement: '了解 Andes', whenEnIncludes: 'Get to know Andes' },
  { pattern: /支持Andes/g, replacement: '支持 Andes', whenEnIncludes: 'Support Andes' },
  { pattern: /展开Andes/g, replacement: '展开 Andes', whenEnIncludes: 'Expand Andes' },
  { pattern: /来自Andes/g, replacement: '来自 Andes', whenEnIncludes: 'from Andes' },
  {
    pattern: /正在重新启动Andes/g,
    replacement: '正在重启 Andes',
    whenEnIncludes: 'Restarting Andes'
  },
  { pattern: /Andes([\u4e00-\u9fff])/g, replacement: 'Andes $1', whenEnIncludes: 'Andes' },
  ...
  {
    pattern: /显示 Andes 移动按钮/g,
    replacement: '显示 Andes Mobile 按钮',
    whenEnIncludes: 'Show Andes Mobile Button'
  }
]
