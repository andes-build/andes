...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Andes IDE': 'Andes IDE',
  'Andes first': 'Andes 优先',
  'Andes Mobile': 'Andes Mobile',
  'Andes logo': 'Andes 标志',
  'Enjoying Andes?': '喜欢 Andes 吗？',
  'Get to know Andes': '了解 Andes',
  'Expand Andes': '展开 Andes',
  'Support Andes': '支持 Andes',
  'Restarting Andes…': '正在重启 Andes…',
  'Show Andes Mobile Button': '显示 Andes Mobile 按钮',
  ...
  "Give agents direct access to Andes's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Andes 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Andes. It is still on your disk.': '来自 Andes。它仍保留在您的磁盘上。',
