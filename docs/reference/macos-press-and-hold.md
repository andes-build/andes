...
```sh
defaults write lat.producthub.andes ApplePressAndHoldEnabled -bool false
```
...
```sh
defaults write lat.producthub.andes ApplePressAndHoldEnabled -bool true
```
...
```sh
defaults delete lat.producthub.andes ApplePressAndHoldEnabled
```
