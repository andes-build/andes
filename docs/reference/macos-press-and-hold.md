...
```sh
defaults write build.andes ApplePressAndHoldEnabled -bool false
```
...
```sh
defaults write build.andes ApplePressAndHoldEnabled -bool true
```
...
```sh
defaults delete build.andes ApplePressAndHoldEnabled
```
