...
export const COMPUTER_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'andes computer get-app-state --app <name|bundle|pid:N> [--window-id <id> | --window-index <n>] [--worktree <selector> | --session <id>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes computer click --app <app> (--element-index <n> | --x <x> --y <y>) [--window-id <id> | --window-index <n>] [--click-count <n>] [--mouse-button <left|right|middle>] [--modifiers <modifier-chord>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [
  ...
  },
  {
    ...
    usage:
      'andes computer perform-secondary-action --app <app> --element-index <n> --action <name> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes computer scroll --app <app> (--element-index <n> | --x <x> --y <y>) --direction <up|down|left|right> [--window-id <id> | --window-index <n>] [--pages <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes computer drag --app <app> (--from-element-index <n> --to-element-index <n> | --from-x <x> --from-y <y> --to-x <x> --to-y <y>) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [
      ...COMPUTER_ACTION_FLAGS,
      'from-element-index',
      'to-element-index',
  ...
  },
  {
    ...
    usage:
      'andes computer type-text --app <app> (--text <text> | --text-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes computer press-key --app <app> --key <key> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes computer hotkey --app <app> --key <key-combo> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [...COMPUTER_ACTION_FLAGS, 'key']
  },
  {
    ...
    usage:
      'andes computer paste-text --app <app> (--text <text> | --text-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [...COMPUTER_ACTION_FLAGS, 'text', 'text-stdin']
  },
  {
    ...
    usage:
      'andes computer set-value --app <app> --element-index <n> (--value <text> | --value-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
