...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'andes open [--json]',
    allowedFlags: [...GLOBAL_FLAGS],
    examples: ['andes open', 'andes open --json']
  },
  ...SERVE_COMMAND_SPECS,
  {
    path: ['status'],
    summary: 'Show app/runtime/graph readiness',
    usage: 'andes status [--json]',
    allowedFlags: [...GLOBAL_FLAGS],
    examples: ['andes status', 'andes status --json']
  },
  {
    path: ['claude-teams'],
    argumentMode: 'passthrough',
    summary: 'Start Claude Code Agent Teams in the current Orca terminal',
    usage: 'andes claude-teams [claude args...]',
    allowedFlags: [...GLOBAL_FLAGS],
    notes: [
  ...
  },
  {
    ...
    examples: ['andes worktree current', 'andes worktree current --json']
  },
  {
    ...
    notes: [
      'This creates a new checkout. For a fresh agent in an existing worktree, use `andes terminal create --worktree active --command "codex"` instead.',
      ...
      '--host runtime:<environment-id> creates on that paired Orca server; use the id from `andes environment list`, not the environment name.',
      'For related work, use the inferred parent or pass --parent-worktree active, folder:<id>, or worktree:<worktreeId> to make the relationship explicit. Worktree ids are the full <repo-id>::<path> values returned by `andes worktree list --json`.',
    ...
    examples: [
      'andes worktree create --name agent-task --agent codex --prompt "hi" --json',
      'andes worktree create --repo id:<repoId> --name related-task --json',
      'andes worktree create --project github:stablyai/orca --host runtime:03ef704c-b180-4b10-998d-e28fbd5de9a3 --name benchmark --json',
      'andes worktree create --repo id:<repoId> --name linear-task --linear-issue https://linear.app/stably/issue/STA-335/test-issue --json',
      'andes worktree create --repo id:<repoId> --name agent-task --agent codex --prompt "hi" --json',
      ...
      'andes worktree create --repo id:<repoId> --name independent-task --no-parent --json'
    ]
  },
  {
    path: ['worktree', 'set'],
    ...
    examples: [
      'andes worktree set --worktree active --linear-issue STA-335 --json',
      'andes worktree set --worktree active --linear-issue null --json'
    ]
  },
  {
    path: ['worktree', 'rm'],
    ...
    usage: 'andes worktree rm --worktree <selector> [--force] [--run-hooks] [--json]',
  ...
  },
  {
    ...
    usage: 'andes worktree ps [--limit <n>] [--json]',
  ...
  },
  {
    ...
    usage: 'andes terminal show [--terminal <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes terminal read [--terminal <handle>] [--cursor <n>] [--limit <n>] [--screen] [--json]',
    ...
    examples: [
      ...
      'andes terminal read --terminal term_abc123 --cursor 42 --limit 1000 --json',
      'andes terminal read --terminal term_abc123 --screen --json'
    ]
  },
  {
    path: ['terminal', 'send'],
  ...
  },
  {
    ...
    usage: 'andes terminal stop --worktree <selector> [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    ...
    examples: [
      ...
      'andes terminal create --worktree path:/projects/myapp --title "RUNNER" --command "opencode"',
      'andes terminal create --worktree path:/projects/myapp --command "opencode" --focus'
    ]
  },
  {
    ...
    usage: 'andes terminal switch [--terminal <handle>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal'],
    examples: ['andes terminal switch --terminal term_abc123']
  },
  {
    path: ['terminal', 'close'],
    summary: 'Close a terminal pane/session, or its whole tab with --tab',
    usage: 'andes terminal close [--terminal <handle>] [--tab] [--json]',
    ...
    examples: [
      'andes terminal close --terminal term_abc123',
      'andes terminal close --terminal term_abc123 --tab --json'
    ]
  },
  {
    path: ['terminal', 'rename'],
    summary: 'Set or clear the title of a terminal tab',
    usage: 'andes terminal rename [--terminal <handle>] [--title <text>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal', 'title'],
    notes: ['Omit --title or pass an empty string to reset to the auto-generated title.'],
    examples: [
      'andes terminal rename --terminal term_abc123 --title "RUNNER"',
      'andes terminal rename --terminal term_abc123 --json'
    ]
  },
  {
    path: ['terminal', 'split'],
    ...
    usage:
      'andes terminal split [--terminal <handle>] [--direction horizontal|vertical] [--command <text>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'terminal', 'direction', 'command'],
    examples: [
      'andes terminal split --terminal term_abc123 --direction horizontal --json',
      'andes terminal split --terminal term_abc123 --command "codex"'
    ]
  }
]
