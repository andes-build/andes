...
export const EMULATOR_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'andes emulator tap <x> <y> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'andes emulator type <text> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: "andes emulator gesture '<json>' [--device <id>] [--worktree <selector>] [--json]",
  ...
  },
  {
    ...
    usage: 'andes emulator button <name> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'andes emulator rotate <orientation> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'andes emulator exec --command <cmd> [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'command', 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'kill'],
    summary: 'Stop helper for device',
    usage: 'andes emulator kill [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes emulator shutdown [--device <id>] [--emulator <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'install'],
    summary: 'Install an APK onto the target Android device',
    usage: 'andes emulator install <apkPath> [--reinstall] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'andes emulator launch <package> [--activity <name>] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'andes emulator permissions <grant|revoke> <package> <permission> [--device <id>] [--json]\n       orca emulator permissions reset [--device <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'device',
      'emulator',
  ...
  },
  {
    ...
    usage: 'andes emulator ax [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'logcat'],
    summary: 'Capture a one-shot logcat dump from the Android device',
    usage: 'andes emulator logcat [--lines <n>] [--device <id>] [--worktree <selector>] [--json]',
