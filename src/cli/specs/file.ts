...
export const FILE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'andes file open <path> [--worktree <selector>] [--json]',
    ...
    examples: [
      ...
      'andes file open --path docs/readme.md --worktree active'
    ]
  },
  {
    path: ['file', 'diff'],
    summary: 'Open a workspace file diff in the Orca editor',
    usage: 'andes file diff <path> [--staged] [--worktree <selector>] [--json]',
    ...
    examples: [
      'andes file diff src/App.tsx',
      'andes file diff --path package.json --staged --worktree branch:feature'
    ]
  },
  {
    path: ['file', 'open-changed'],
    summary: 'Open all git-changed files for a workspace',
    usage: 'andes file open-changed [--mode edit|diff|both] [--worktree <selector>] [--json]',
    ...
    examples: [
      'andes file open-changed',
      'andes file open-changed --mode both',
      'andes file open-changed --mode diff --worktree active'
    ]
  }
]
