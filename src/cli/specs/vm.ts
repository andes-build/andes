...
export const VM_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'andes vm recipe doctor <recipe-id> [--repo-path <path>] [--provision|--connect] [--json]',
    ...
    examples: [
      'andes vm recipe doctor cloud-sandbox',
      'andes vm recipe doctor cloud-sandbox --repo-path /path/to/repo --json',
      'andes vm recipe doctor cloud-sandbox --provision --json'
    ]
  }
]
