      ...
      if (skillInstalled) {
        toast.message(
          translate(
            ...
            'Skill is installed. Enable the command line tool to finish setup.'
          )
        )
        return
      }
      if (cliReady) {
        toast.message(
          translate(
            ...
            'The command line tool is ready. Install the skill to finish setup.'
          )
        )
        return
      }
      ...
      if (mountedRef.current && isOrcaCliAvailableOnPath(next)) {
        toast.success(
          translate(
            ...
            'Registered the command line tool in PATH.'
          )
        )
      }
    } finally {
