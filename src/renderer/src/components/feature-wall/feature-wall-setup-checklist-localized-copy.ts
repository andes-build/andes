  ...
  (): Record<FeatureWallSetupStepId, LocalizedFeatureWallSetupChecklistCopy> => ({
    ...
    browser: {
      ...
      description: translate(
        ...
        'Browse your web app without leaving Andes. Grab any element and send its exact source and styles to an agent with one click.'
      )
    },
    notifications: {
      name: translate(
    ...
    'agent-capabilities': {
      ...
      description: translate(
        ...
        'Register the Andes shell command and install agent skills for browser, computer, and orchestration workflows.'
      )
    },
    'task-sources': {
      name: translate(
    ...
    'add-two-repos': {
      ...
      description: translate(
        ...
        'Bring your key repos into Andes so you can start agent work without hunting for folders.'
      )
    }
  })
)
