      ...
      <DialogContent className="gap-4 sm:max-w-[620px]">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            {translate(
              ...
              'Install the command line tool and orchestration skill so agents can coordinate through Andes.'
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <AgentSkillSetupPanel
          ...
          description={translate(
            ...
            'Enables agents to hand off context and coordinate work through Andes.'
          )}
