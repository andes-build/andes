...
export function LinkRoutingPreferenceDialogProvider({
  ...
  useEffect(() => {
    ...
    void requestPreference({
      ...
      preview: true,
      url: 'https://github.com/andes-build/andes/pull/1234'
    })
  }, [requestPreference])
                ...
                <DialogTitle className="text-xl leading-tight">
                  {openLinksInAppDefault
                    ? translate(
                        ...
                        "Keep terminal links in Andes's browser?"
                      )
                    : translate(
                        'auto.components.link.routing.preference.dialog.title',
                        "Open terminal links in Andes's browser?"
                      )}
                </DialogTitle>
                <DialogDescription className="text-sm leading-relaxed">
                  {openLinksInAppDefault
                    ...
                    : translate(
                        ...
                        "Use Andes's browser for terminal links, or keep your system browser."
                      )}
                </DialogDescription>
              </div>
            </DialogHeader>
              ...
              <div className="space-y-1">
                <p>
                  {translate(
                    ...
                    'Andes can use imported cookies for logged-in sites.'
                  )}
                </p>
                <p>
                  {translate(
