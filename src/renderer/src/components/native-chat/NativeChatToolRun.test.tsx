...
// This file exercises the raw, developer-mode-shaped rendering. Simple
// mode's plain-language activity line (spec 013, criterion 7) has its own
// coverage in `native-chat-activity-phrase.test.ts`.
