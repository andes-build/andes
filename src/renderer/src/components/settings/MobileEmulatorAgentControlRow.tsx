        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Let coding agents control the active mobile emulator with command line commands.'
            )}
          </p>
        </div>
        <span
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Registers the command line tool so agents can control the active emulator from their shell.'
              )}
            </p>
            ...
            {setup.cliBusy ? (
              <p className="text-[11px] leading-snug text-muted-foreground">
                {translate(
                  ...
                  'Registering the command line tool'
                )}{' '}
                {setup.cliInstallStatus?.commandPath ? (
                  <code className="rounded bg-muted px-1 py-0.5">
                    {setup.cliInstallStatus.commandPath}
        ...
        <div className={cn('py-3', setup.step2Blocked && 'opacity-60')}>
          <AgentSkillSetupPanel
            ...
            description={translate(
              ...
              'Enables agents to use command line commands, including mobile emulator control.'
            )}
            ...
            openingHint={translate(
              ...
              'Checking the command line tool before opening skill setup.'
            )}
