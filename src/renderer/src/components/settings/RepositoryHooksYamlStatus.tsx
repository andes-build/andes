    ...
    case 'update-available':
      return {
        ...
        description: translate(
          ...
          'The file contains configuration keys that this version of Andes does not recognize. You may need to update Andes, or check the file for typos.'
        )
      }
    case 'invalid':
      return {
        ...
        description: translate(
          ...
          'The core configuration file exists in the repo root, but Andes could not parse the supported hook definitions yet.'
        )
      }
    default:
      return {
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              <p>
                {translate(
                  ...
                  'The file is present, but Andes could not find valid `scripts` or `issueCommand` definitions.'
                )}
              </p>
