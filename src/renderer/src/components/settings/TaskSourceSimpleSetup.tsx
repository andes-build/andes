...
export function CodeHostSetupSteps(
  ...
  const connectionDescription = props.unavailable
    ? translate(
        ...
        "Andes couldn't check this connection. Try again, or open Integrations for setup details."
      )
    : translate(
        'auto.components.settings.TasksPane.connectCodeHostDescription',
        'Install and authenticate the CLI under Integrations so Andes can load issues.'
      )
