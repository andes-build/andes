          ...
          <DialogDescription className="text-xs">
            {mode === 'yaml'
              ? translate(
                  ...
                  'Import theme YAML files (Warp format) as Andes terminal themes.'
                )
              : translate(
                  'auto.components.settings.WarpThemeImportModal.description',
                  'Import Warp themes as Andes terminal themes.'
                )}
          </DialogDescription>
        </DialogHeader>
              ...
              {!preview.error && mode !== 'yaml' ? (
                <p>
                  {translate(
                    ...
                    "Warp's preloaded themes are part of the Warp app and can't be read from disk. Andes already includes most of them, like Dracula, Gruvbox, Solarized, and Tokyo Night."
                  )}
                </p>
              ) : null}
              {!preview.error && mode !== 'yaml' ? (
