...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Command Line'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the command line tool.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the command line skill so agents know to use the command line tool.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Andes version.'
    ),
    keywords: [
