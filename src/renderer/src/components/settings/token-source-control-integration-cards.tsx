          ...
          <p className="text-xs text-muted-foreground">
            {status === 'unavailable' ? (
              ...
              translate(
                ...
                'Azure DevOps credentials are configured but could not authenticate. Check the token, API base URL, and repository permissions, then restart Andes if environment variables changed.'
              )
            )}
          </p>
          ...
          <p className="text-xs text-muted-foreground">
            {status === 'unavailable' ? (
              ...
              translate(
                ...
                'Gitea credentials are configured but could not authenticate. Check the token, API base URL, and repository permissions, then restart Andes if environment variables changed.'
              )
            )}
          </p>
          <div className="flex items-center gap-2">
