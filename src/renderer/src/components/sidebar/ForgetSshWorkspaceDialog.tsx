...
export function ForgetSshWorkspaceDialog(): React.JSX.Element | null {
  ...
  const forgetDescription = translate(
    ...
    'Removes this workspace from Andes only. Files, the Git worktree, and branches on {{host}} are left untouched.',
    { host: hostLabel }
  )
          ...
          <DialogDescription className="text-xs">
            {canReconnect
              ? translate(
                  ...
                  'The SSH host for this workspace is not connected. Reconnect to delete it on the remote too, or remove it from Andes only.'
                )
              : translate(
