...
export function HostRemoveDialog({
  ...
  const description =
    target.kind === 'runtime'
      ? translate(
          ...
          'This opens the Andes servers settings where you can remove this server.'
        )
      : hasWorkspaces
        ? translate(
            'auto.components.sidebar.HostRemoveDialog.hostHasWorkspacesDefault',
            'Removes {{value0}} and its credentials from this computer. Its {{value1}} stay in Andes — remote files are not touched.',
  ...
  const deleteOptionLabel = isConnected
    ...
    : translate(
        ...
        'Also remove these {{value0}} from Andes',
