...
const GITHUB_URL = 'https://github.com/andes-build/andes'
...
export function SidebarSettingsHelpMenu(): React.JSX.Element {
  ...
  const handleRestartOrca = (): void => {
    ...
    toast.info(
      translate('auto.components.sidebar.SidebarSettingsHelpMenu.5161eef55d', 'Restarting Andes…')
    )
