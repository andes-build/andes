...
function operationError(status: string): string {
  return status === 'reconnect-required'
    ? translate(
        ...
        'Reconnect your Andes account before sharing.'
      )
    : translate(
        'auto.components.skills.SkillShareDialog.unconfigured',
        'Connect an Andes Cloud account before sharing.'
      )
}
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Andes could not send the cancellation request. The upload may still finish.'
        )
      )
    }
  }
