...
describe('terminal link action routing', () => {
  ...
  it('offers system browser first and Andes second when system browser is the default', () => {
    const request = vi.fn()
    ...
    expect(request.mock.calls[0][0].alternate.label).toBe('Andes Browser')
  ...
  it('offers Andes first and system browser second when Andes is the default', () => {
    const request = vi.fn()
    ...
    expect(request.mock.calls[0][0].primary.label).toBe('Andes Browser')
  ...
  it('routes an explicit Andes Browser action to the owning runtime', () => {
    const request = vi.fn()
  ...
  it('routes an explicit Andes Browser action through the owning SSH workspace', () => {
    const request = vi.fn()
