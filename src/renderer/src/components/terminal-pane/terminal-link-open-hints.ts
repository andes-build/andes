...
export function getTerminalOrcaFileOpenHint(showActions = true): string {
  ...
  return isMacPlatform()
    ? `${prefix}⌘+click to open in Andes`
    : `${prefix}Ctrl+click to open in Andes`
}
...
export function getTerminalUrlOpenHint(options: TerminalUrlOpenHintOptions = {}): string {
  ...
  if (invertsToOrca) {
    return isMacPlatform()
      ? `${prefix}⌘+click to open, or ⇧⌘+click to open in Andes`
      : `${prefix}Ctrl+click to open, or Shift+Ctrl+click to open in Andes`
  }
  return isMacPlatform()
...
export function getTerminalUrlOrcaBrowserHint(): string {
  return isMacPlatform() ? '⇧⌘+click to open in Andes' : 'Shift+Ctrl+click to open in Andes'
}
