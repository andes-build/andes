...
import { createWorkspaceScopeSlice } from './slices/workspace-scope'
import { createCommandCenterViewSlice } from './slices/command-center-view'
...
export const useAppStore = create<AppState>()(
  withReactCommitCascadeWriteProbe((...a) => {
    ...
    return {
      ...
      ...createWorkspaceScopeSlice(...a),
      ...createCommandCenterViewSlice(...a)
    }
  })
)
